# @title Vyper Dynamic Array for uint256 v1
...
@public
@constant
def get(_ls: uint256, _idx: uint256) -> uint256:
...
@private
def _set(_ls: uint256, _idx: uint256, _val: uint256, _sender: address):
...
@public
def set(_ls: uint256, _idx: uint256, _val: uint256):
    self._set(_ls, _idx, _val, msg.sender)

@public
def append(_ls: uint256, _val: uint256):
